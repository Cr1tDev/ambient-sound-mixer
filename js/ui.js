export class UI {
  ...
  // Reset all UI elemtnts to default state
  resetUI() {
    // Reset slideres to 0
  ...
  // Add custome preset to UI
  addCustomPreset(name, presetId) {
    const button = this.createCustomPresetButton(name, presetId);
    this.customPresetContainer.appendChild(button);
  }

  // Highligh avtive preset
